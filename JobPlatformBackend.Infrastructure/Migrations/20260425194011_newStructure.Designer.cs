...
namespace JobPlatformBackend.Infrastructure.Migrations
{
    ...
    [Migration("20260425194011_newStructure")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPlatformBackend.Domain.src.Entity.CareerArchitect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobPlatformBackend.Domain.src.Entity.UserDashboardStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobPlatformBackend.Domain.src.Entity.CareerArchitect", b =>
                {
                    b.HasOne("JobPlatformBackend.Domain.src.Entity.User", "User")
                        .WithOne("CareerPath")
                        .HasForeignKey("JobPlatformBackend.Domain.src.Entity.CareerArchitect", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobPlatformBackend.Domain.src.Entity.UserDashboardStats", b =>
                {
                    b.HasOne("JobPlatformBackend.Domain.src.Entity.User", "User")
                        ...
                        .HasForeignKey("JobPlatformBackend.Domain.src.Entity.UserDashboardStats", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
