...
namespace JobPlatformBackend.Domain.src.Abstractions
{
	public interface IDashboardRepository : IBaseRepository<User>
	{
		...
		Task UpdateUserDashboardDataAsync(int userId, string headline, string exp, string marketValue, string recommendation, int progres, string targetTitle, string roadMap);
	}
}
